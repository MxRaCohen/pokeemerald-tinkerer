...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_TINKATINK)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_TINKATUFF)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_TINKATON )
